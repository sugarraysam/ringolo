...
[`Op`]: https://docs.rs/ringolo/latest/ringolo/future/lib/struct.Op.html
[`Sleep`]: https://docs.rs/ringolo/latest/ringolo/time/struct.Sleep.html
[`IOSQE_IO_LINK`]: https://unixism.net/loti/tutorial/link_liburing.html
[`OpList::new_chain`]: https://docs.rs/ringolo/latest/ringolo/future/lib/struct.OpList.html
[`OpList::new_batch`]: https://docs.rs/ringolo/latest/ringolo/future/lib/struct.OpList.html
[`TcpListener::bind`]: https://docs.rs/ringolo/latest/ringolo/future/experimental/net/tcp/struct.TcpListener.html#method.bind
[`Multishot`]: https://docs.rs/ringolo/latest/ringolo/future/lib/struct.Multishot.html
[`Tick`]: https://docs.rs/ringolo/latest/ringolo/time/struct.Tick.html
...
determine when a task is "stealable". View the detailed implementation within the [task module].

[task module]: https://docs.rs/ringolo/latest/ringolo/task/index.html
...
* **Read-only inputs:** Pointers to input data (such as file paths) are guaranteed to remain stable until the request
  is **submitted**.
* **Writable outputs:** Pointers to mutable buffers (such as read destinations) are guaranteed to remain stable until
  the operation **completes**.

Ringolo handles these complex lifetime requirements transparently using **self-referential structs** and **pinning**.
By taking ownership of resources and pinning them in memory, the runtime ensures the kernel never encounters a dangling
pointer or a use-after-free error.

For implementation details on these safe primitives, see the [`future::lib`] module.

[`future::lib`]: https://docs.rs/ringolo/latest/ringolo/future/lib/index.html
...
[multishot timers]: https://docs.rs/ringolo/latest/ringolo/future/lib/ops/struct.TimeoutMultishot.html
[direct descriptors]: https://docs.rs/ringolo/latest/ringolo/future/lib/enum.UringFdKind.html#variant.Fixed
[OnCleanupError]: https://docs.rs/ringolo/latest/ringolo/runtime/enum.OnCleanupError.html
...
- [ ] Support for [Registered Buffers](https://man7.org/linux/man-pages/man3/io_uring_register_buffers.3.html)
- [ ] Higher level user libraries for building futures and programs (e.g: `future::lib::{fs, sync, net}`) with examples
